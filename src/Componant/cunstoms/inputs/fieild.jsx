...
function FieildInput({placeholder,label,type,icon}) {
    return (
        <div className=' relative text-secoundColor'>
            ...
            <input type={type} placeholder={placeholder} className=' flex-1 w-full py-2  bg-transparent px-1 rounded-s-lg outline-none  placeholder:text-secoundColor'/>
